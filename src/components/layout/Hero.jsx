...
const Hero = () => {
  ...
  return (
    <section
      ref={comp}
      className="relative min-h-[105vh] flex items-center overflow-hidden bg-[#0F0A08] pt-20"
    >
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-[1200px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-center">
          <div className="order-1 flex flex-col justify-center text-center lg:text-left">
            ...
            <div ref={titleRef} className="will-change-transform">
              <h1 className="font-display text-5xl md:text-6xl xl:text-7xl font-black text-white leading-[1.1] uppercase drop-shadow-2xl">
                Heo Quay <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] via-[#F9E29F] to-[#D4AF37]">
                  Nguyên Con
                </span>
              </h1>
              <span className="font-display text-2xl md:text-4xl xl:text-5xl block mt-3 text-white/90 font-bold tracking-tight">
            ...
            <p
              ref={descRef}
              className="font-sans italic text-gray-400 text-base md:text-lg xl:text-xl mb-8 max-w-xl leading-relaxed border-l-2 border-[#991b1b] pl-6 mt-6 mx-auto lg:mx-0"
            >
            ...
            >
              ...
              <a
                href="#contact"
                className="flex items-center justify-center gap-3 bg-white/5 text-white px-8 py-4 rounded-full font-bold text-base xl:text-lg hover:bg-white/15 hover:scale-105 transition-all backdrop-blur-md border border-white/20"
              >
          ...
          <div ref={rightImgRef} className="relative order-2 hidden lg:block">
            <div
              className="relative z-10 aspect-[4/5] w-full max-w-[500px] ml-auto
                            rounded-[3rem] overflow-hidden border-[4px] border-[#c5a059]/30 shadow-2xl"
            >
              <img
                src={rightHeroImg}
                width="750"
            ...
            <div
              className="absolute -top-6 -right-6 bg-[#991b1b] text-white p-5 xl:p-6 rounded-2xl shadow-2xl
                            z-20 flex flex-col items-center rotate-6 border border-[#c5a059]/30"
            >
              <span className="text-3xl xl:text-4xl font-black font-display">
                100%
              </span>
            ...
            <div
              className="absolute -bottom-6 -left-6 bg-gold-gradient text-[#1a0f0a] p-5 xl:p-6 rounded-2xl shadow-2xl 
                            z-20 flex flex-col items-center -rotate-6 border border-white/20"
            >
              <span className="text-xl xl:text-2xl font-black font-sans uppercase">
                Giòn Rụm
              </span>
        ...
        <div className="relative z-10 pt-24  flex flex-col items-center gap-2 text-amber-200/30">
